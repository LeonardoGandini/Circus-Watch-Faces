...
public class Seal extends CanvasWatchFaceService {
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(Seal.this)
...
//***DEBUG***//
        ...
        private void registerReceiver() {
            ...
            Seal.this.registerReceiver(timeZoneReceiver,
        ...
        private void unregisterReceiver() {
            ...
            Seal.this.unregisterReceiver(timeZoneReceiver);
        }
