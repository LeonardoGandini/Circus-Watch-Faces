...
public class Equilibrist extends CanvasWatchFaceService {
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(Equilibrist.this)
...
//***DEBUG***//
          ...
          /*  float minuteRotation = time.second + milliseconds / 1000f;
            ...
            canvas.save();
            canvas.translate(centerX - 15.f, centerY - 25.f);
        ...
        private void registerReceiver() {
            ...
            Equilibrist.this.registerReceiver(timeZoneReceiver,
        ...
        private void unregisterReceiver() {
            ...
            Equilibrist.this.unregisterReceiver(timeZoneReceiver);
        }
